...
impl UserBmc {
    ...
    pub async fn create(
        ...
        let user_id = base::create::<Self, _>(ctx, mm, user_fi).await.map_err(|model_error| match model_error {
        ...
        sqlx_error.as_database_error().and_then(|db_error| {
            db_error.code().zip(db_error.constraint())
                    ...
                    if code == "23505" && (constraint == "user_username_key" || constraint == "user_username_norm_key")
                    {
